    ...
    _newWorkout(e) {
       e.preventDefault();
        ...
        if (type === 'running') {
            ...
            if (!validInputs(distance, duration, cadence) || !allPositive(distance, duration, cadence)) return alert('invalid inputs')
        ...
        if (type === 'cycling') {
            ...
            if (!validInputs(distance, duration, elevation) || !allPositive(distance, duration, elevation)) return alert('invalid inputs')
